...
<p style="margin-top:0.5em;">
  <span style="display:inline-block;padding:4px 10px;margin-right:8px;border-radius:12px;background:#eef4fa;color:#07558c;font-size:0.9em;">
    总访问量: <b id="busuanzi_value_site_pv">–</b>
  </span>
  <span style="display:inline-block;padding:4px 10px;border-radius:12px;background:#fdecec;color:#c14a4a;font-size:0.9em;">
    访客人数: <b id="busuanzi_value_site_uv">–</b>
  </span>
</p>

<!-- 访客地理分布地图 (Clustrmaps) -->
<div style="margin-top:1em;">
  <a href="https://clustrmaps.com/site/1c5vd" title="访问统计" target="_blank" rel="noopener">
    <img src="//www.clustrmaps.com/map_v2.png?d=4FJDDsvjuSFzFRBj90PhbhqvxK27XvsyT2vmNjJAHCQ&cl=ffffff&w=a" alt="访客地理分布" style="max-width:100%;height:auto;" />
  </a>
</div>
